    ...
    describe("Test de adopciones", async () => {
        ...
        it("El endpoint POST /api/adoptions/:uid/:pid debe crear una adopcion nueva correctamente", async () => {
            ...
            const userMock = {
                first_name: "pepe",
                last_name: "rodriguez",
                email: "post@adoptiontest.com", /*Cambiar el email cada vez que se haga un test para evitar conflicto con la base de datos*/
                password: "123456"
            }
        ...
        it("El endpoint GET /api/adoptions/aid debe devolver la adopcion indicada correctamente", async () => {
            ...
            const userMock = {
                first_name: "pepe",
                last_name: "rodriguez",
                email: "get@adoptiontest.com", /*Cambiar el email cada vez que se haga un test para evitar conflicto con la base de datos*/
                password: "123456"
            }
